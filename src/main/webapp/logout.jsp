  ...
  <main class="main">
    ...
    <section id="book-a-table" class="book-a-table section">
      ...
      <div class="container d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
        <form class=" text-left border-login" method="post" action="logout-user"> <!-- Center text inside form -->

          <button type="submit" class="btn btn-primary mb-3">Log Out</button> <br>
