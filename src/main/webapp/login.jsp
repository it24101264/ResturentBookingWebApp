  ...
  <main class="main">
    ...
    <section id="book-a-table" class="book-a-table section">
      ...
      <div class="container section-title text-center" data-aos="fade-up">
        <h2>LOG IN TO RESTAURANT</h2>
        <p>Log in to your account</p>
      </div><!-- End Section Title -->
  
      <div class="container d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
        <form class=" text-left border-login" method="post" action="login-user"> <!-- Center text inside form -->
          ...
          <button type="submit" class="btn btn-primary mb-3">Log In</button> <br>
          If you are new <a class="register-login" href="register.jsp">click here to register.</a>
