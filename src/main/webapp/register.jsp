  ...
  <main class="main">
    ...
    <section id="book-a-table" class="book-a-table section">
      ...
      <div class="container d-flex justify-content-center " data-aos="fade-up" data-aos-delay="100">
        ...
        <form class=" text-left border-login" method="post" action="register-user"> <!-- Center text inside form -->
          ...
          <div class="mb-3 ">
              <label  class="form-label">Phone Number <span class="example">Ex:761234567</span></label>
              <input type="number" id="contact" class="form-control" name="mobileNum"  />
          </div>
          <div class="mb-3 ">
